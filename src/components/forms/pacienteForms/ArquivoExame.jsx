...
export default function ArquivoExame({ formData, handleChange, setFormData }) {
  ...
  return (
    <div className="p-6 space-y-4">
      <div>
        <label className="block text-green-900 body-font text-sm font-medium mb-2">
          Arquivo do exame
        </label>
        ...
        >
          ...
          >
            ...
            <span className="text-green-900 body-font">
              {arquivo ? arquivo.name : "Clique para importar o exame"}
            </span>
            <span className="text-sm text-neutral-400 body-font">
        ...
        {arquivo && (
          <div className="mt-4 p-3 bg-green-50 rounded-md flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-green-700 body-font">{arquivo.name}</span>
            </div>
            <button
              type="button"
              onClick={() => {
